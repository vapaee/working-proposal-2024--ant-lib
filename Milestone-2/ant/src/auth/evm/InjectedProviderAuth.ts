...
// import { getAntelope, useAccountStore, useChainStore, useEVMStore, useFeedbackStore } from '../..';
import {
    AntelopeError,
    EthereumProvider,
    EvmABI,
...
import { TELOS_NETWORK_NAMES, TELOS_ANALYTICS_EVENT_NAMES } from '../../chains/chain-constants';
import { BraveAuthName, MetamaskAuthName, SafePalAuthName } from '../../wallets';
