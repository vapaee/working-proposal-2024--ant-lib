...
exports.initFuelUserWrapper = void 0;
...
class FuelUserWrapper extends universal_authenticator_library_1.User {
    constructor(user) {
        super();
        this.fuelServiceEnabled = false;
        ...
        this.signArbitrary = (publicKey, data, helpText) => __awaiter(this, void 0, void 0, function* () { return this.user.signArbitrary(publicKey, data, helpText); });
        this.verifyKeyOwnership = (challenge) => __awaiter(this, void 0, void 0, function* () { return this.user.verifyKeyOwnership(challenge); });
        this.getAccountName = () => __awaiter(this, void 0, void 0, function* () { return this.user.getAccountName(); });
        this.getChainId = () => __awaiter(this, void 0, void 0, function* () { return this.user.getChainId(); });
        this.getKeys = () => __awaiter(this, void 0, void 0, function* () { return this.user.getKeys(); });
    ...
    setAvailability() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                this.fuelServiceEnabled = (yield fetch(this.fuelRpc)).status === 200;
            }
            catch (e) {
                console.error(e);
            }
    ...
    signTransaction(originalTransaction, originalconfig) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const actions = (_a = originalTransaction.actions) !== null && _a !== void 0 ? _a : [];
                // collect all contract abis
                const abi_promises = actions.map(a => client.v1.chain.get_abi(a.account));
                const responses = yield Promise.all(abi_promises);
                const abis = responses.map(x => x.abi).filter(x => x !== undefined);
                ...
                const signer = eosio_1.PermissionLevel.from({
                    actor: (yield this.user.getAccountName()),
                    permission: this.requestPermission,
                });
                // Submit the transaction to the resource provider endpoint
                const cosigned = yield fetch(this.resourceProviderEndpoint, {
                    body: JSON.stringify({
                        signer,
                        packedTransaction,
                    }),
                ...
                const rpResponse = yield cosigned.json(); /*as ResourceProviderResponse*/
                ...
                switch (rpResponse.code) {
                    ...
                    case 200:
                        ...
                        const locallySigned /*: SignedTransactionResponse*/ = yield this.user.signTransaction(modifiedTransaction, Object.assign(originalconfig, { broadcast: false })); /* as SignedTransactionResponse*/
                        // When using CleosAuthenticator the transaction returns empty
                        if (!locallySigned.transaction.signatures) {
                            return Promise.reject('The transaction was not broadcasted because no signatures were obtained');
                        }
                        ...
                        const pushResponse = yield client.v1.chain.push_transaction(modifiedTransaction);
...
function initFuelUserWrapper(user, config) {
    return __awaiter(this, void 0, void 0, function* () {
        const fuelUserWrapper = new FuelUserWrapper(user);
        fuelUserWrapper.init(config);
        yield fuelUserWrapper.setAvailability();
        return fuelUserWrapper;
    });
}
exports.initFuelUserWrapper = initFuelUserWrapper;
//# sourceMappingURL=GraymassFuel.js.map